...
import HomeLogin from '@/components/authComponents/home.login';
import { IUser } from '@/typescript/home';
import Box from '@mui/material/Box';
import { useAppDispatch } from '@/redux/hooks';
import { logout } from '@/redux/Slice/authSlice';
import { toast } from 'react-toastify';
import HomeRegister from '../authComponents/home.register';
    ...
    <React.Fragment>
      {data
        ...
        : (<Box>
          ...
          <HomeLogin open={open} handleClose={handleClose} handleClickOpenRegister={handleClickOpenRegister} />
