...
import TourismMenuSelect from "../tourismComponents/tourism.menuSelect";

const RoomTicket = ({ data, isLoading, setSortOrder, page, setPage, totalPages }: ITour) => {
  const [liked, setLiked] = useState<Record<number, boolean>>({});

  const router = useRouter();

  const handleDetail = (plug: number) => {
    router.push(`/hotel/allRoom/${plug}`)
  }
