'use client'
import { getOrderAPI } from '@/api/home/api.admin'
...
import TableManageOrders from '@/components/adminComponents/manageOrder/table.manageOrders'

const SearchManageOrdersSchema = Yup.object().shape({
    name: Yup.string(),
    status: Yup.string(),
});
        ...
        <Box
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                <Formik
                    ...
                    validationSchema={SearchManageOrdersSchema}
                    onSubmit={(values) => {
                        setName(values.name)
